...
**v0.0.5.** Being built test-first. `AreaHits` and `HitPlane` are complete; **`FiringCadence` is
still a stub**. `dotnet test` reports 21 failures and 42 passes, and that is the intended state, not
a broken build.
